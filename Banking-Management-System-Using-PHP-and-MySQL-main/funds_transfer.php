<?php
session_start();
if(!isset($_SESSION['loginid'])){ header('location:login.php');}
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<link rel="stylesheet" href="assets/css/home.scss">
 ...
 $ar = $con->query("select * from useraccounts where id = '$_SESSION[loginid]'");
 ...
 ?>
  ...
  <div class="modal-dialog" role="document">
    ...
    if (isset($_POST['send']))
    {
      if ($con->query("insert into feedback (message,userid) values ('$_POST[msg]','$_SESSION[loginid]')")) {
